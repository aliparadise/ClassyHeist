...
namespace Heist2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome to Classy Heist Management");
            while (true)
            {
                List<IRobber> rolodex = new List<IRobber>
                {
                    new Muscle("Ali", 50, 15),
                    new Hacker("Nathan", 25, 15),
                    new LockSpecialist("Jasmine", 30, 15),
                    new Muscle("Blue42", 50, 20),
                    new Hacker("Josh", 50, 20)
                };
